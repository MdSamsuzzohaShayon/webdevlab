<template>
  <div
    ...
    v-bind:style="{ backgroundImage: 'url(https://source.unsplash.com/random/239x319)' }"
  >
    ...
    >
      ...
      <h1 rel="noopener noreferrer" class="font-serif text-2xl font-semibold group-hover:underline dark:text-gray-100">
