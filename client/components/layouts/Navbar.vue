<template>
  <header :class="`w-full ${bgClr} ${txtClr}`">
    <div :class="`container ${cm} ${cp}`">
      <!-- ======= 🌐 STATIC MENU START 🌐 ======= -->
      <div
        :class="`mobile-navbar w-full flex justify-between items-center ${hp} border-b-primary md:border-0`"
      >
        <div class="menu-wrapper w-1/6 md:w-fit">
          <Icon
            name="humbleicons:align-text-justify"
            :color="iconClr"
            :size="is"
            @click="toggleMenu"
          />
        ...
        <div :class="`w-fit hidden md:block`">
          <MainMenuItem :menu-list="menuList" />
        </div>
        <!-- ======= 🌐 NAV MENU END 🌐 ======= -->
          ...
          <nav class="mt-4">
            <ul class="mt-4 w-full">
              <li
                ...
                :key="item.id"
                :class="`w-full leading-10 bg-gray-700 mb-2 px-2`"
              >
                <NuxtLink
                  :to="item.link"
                  target="_blink"
            ...
            <form>
              ...
              <div class="input-group-inline">
                ...
                <label for=""
                  ...
                  terms of use regarding the storage of the data submitted through this form.</label
                >
              </div>
            </form>
          </div>
...
const socialLinks: ISocialLink[] = [
  {
    id: 1,
    text: 'Github',
    link: 'https://github.com/MdSamsuzzohaShayon',
  ...
  },
  {
    id: 2,
    text: 'YouTube',
    link: 'https://www.youtube.com/@web-dev-lab',
  ...
  },
  {
    id: 3,
    text: 'Linkedin',
    link: 'https://bd.linkedin.com/in/md-samsuzzoha?trk=people-guest_people_search-card',
  ...
  },
  {
    id: 3,
    text: 'X',
    link: 'https://twitter.com/shayon_md?lang=en',
