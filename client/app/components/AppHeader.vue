    ...
    <nav class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="flex justify-between items-center h-16">
        ...
        <div class="hidden md:block">
          <div class="ml-10 flex items-baseline space-x-8">
            ...
            <NuxtLink to="/shots" class="nav-link capitalize">shots</NuxtLink>
            <NuxtLink to="/services" class="nav-link capitalize">services</NuxtLink>
            <NuxtLink to="/about" class="nav-link capitalize">about</NuxtLink>
            <NuxtLink to="/contact" class="nav-link capitalize">contact</NuxtLink>
          </div>
        </div>
      ...
      <div v-show="isMobileMenuOpen" class="md:hidden">
        ...
        >
          ...
          <NuxtLink to="/shots" class="mobile-nav-link capitalize">shots</NuxtLink>
          <NuxtLink to="/about" class="mobile-nav-link capitalize">about</NuxtLink>
          <NuxtLink to="/about" class="mobile-nav-link capitalize">about</NuxtLink>
          <NuxtLink to="/contact" class="mobile-nav-link capitalize">contact</NuxtLink>
          <div class="pt-3">
...
.nav-link capitalize.router-link-active {
  @apply text-primary-600 bg-primary-50;
}

.mobile-nav-link capitalize {
